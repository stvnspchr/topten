...
/***/ function(module, exports, __webpack_require__) {
	...
	var Input = React.createClass({
		...
		commentHandler: function commentHandler(event) {
			this.setState({ comment: event.target.value });
		},
		doRequest: function doRequest(val) {
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement('input', { className: 'u-full-width', type: 'text', placeholder: 'Type an album name', onChange: this.changeHandler, value: this.state.value })
					)
				),
				React.createElement(
					'div',
					{ className: 'row ' + resultClass },
					React.createElement(
						'div',
						...
						React.createElement('textarea', { className: 'u-full-width', placeholder: 'Enter a comment', onChange: this.commentHandler })
					),
					React.createElement(
						'div',
						{ className: 'five columns text-center' },
						React.createElement('img', { src: this.state.image, width: '100%' }),
						React.createElement(
							'a',
							{ className: 'button', href: this.state.link, target: '_blank' },
					...
					React.createElement(
						...
						React.createElement(
							'a',
							{ className: 'button button-primary', href: '#', onClick: this.save },
							React.createElement('i', { className: 'fa fa-plus-circle fa-lg' })
						)
					)
				)
			);
	...
	var ListItem = React.createClass({
		...
		delete: function _delete(event) {
			event.preventDefault();
			albums.splice(this.props.order - 1, 1);
			localStorage.setItem('albums', JSON.stringify(albums));
			location.reload();
		},
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					'div',
					{ className: 'two columns text-center' },
					React.createElement(
						'h1',
						{ className: 'm-a-0' },
						this.props.order,
					...
					React.createElement(
						'p',
						{ className: 'm-a-0' },
						React.createElement('i', { className: 'fa fa-bars fa-lg text-muted' })
					),
					React.createElement(
						'a',
						{ href: '#', className: 'm-a-0', id: this.props.order, onClick: this.delete },
						React.createElement('i', { className: 'fa fa-trash fa-lg text-muted' })
					)
				),
				React.createElement(
					'div',
				...
				React.createElement(
					'div',
					{ className: 'four columns text-center' },
					React.createElement('img', { src: this.props.image, width: '100%' }),
					React.createElement(
						'a',
						{ className: 'button', href: 'https://open.spotify.com/album/' + this.props.id, target: '_blank' },
						React.createElement('i', { className: 'fa fa-spotify fa-lg' }),
						' Listen'
					)
				)
			);
	...
	var List = React.createClass({
		...
		render: function render() {
			...
			this.props.items.forEach((function (item, index) {
				var i = index + 1;
				rows.push(React.createElement(ListItem, { key: item.id, order: i, id: item.id, album: item.album, artist: item.artist, link: item.link, image: item.image, comment: item.comment }));
			}).bind(this));
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'div',
						{ className: 'one-half column search' },
						React.createElement(
							'h1',
					...
					React.createElement(
						'div',
						{ className: 'one-half column list' },
						React.createElement(List, { items: albums })
					)
				)
			);
		}
